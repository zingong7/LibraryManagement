<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminbookinv.aspx.cs" Inherits="WebApplication1.adminbookinv" %>
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <img id="imgview" Height="150px" Width="100px" src="book_inventory/pic1.png" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
